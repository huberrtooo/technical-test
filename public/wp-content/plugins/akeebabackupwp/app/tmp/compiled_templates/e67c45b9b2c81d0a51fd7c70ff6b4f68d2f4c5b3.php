<?php /* /Users/hubertoszywa/Local Sites/technical-test/app/public/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Update/extract.blade.php */ ?>
<?php
/**
 * @package   solo
...
<div id="extractProgress">
	...
	<div class="akeeba-block--info" id="extractProgressInfo">
		<h4>
			<?php echo \Awf\Text\Text::_('SOLO_UPDATE_EXTRACT_LBL_EXTRACTPROGRESS'); ?>
		</h4>
...
<div id="extractPingError" style="display: none">
	<div class="akeeba-block--failure">
		<h3>
			<?php echo \Awf\Text\Text::_('SOLO_UPDATE_EXTRACT_ERR_CANTPING_TEXT'); ?>
		</h3>
		<p>
			<?php echo \Awf\Text\Text::_('SOLO_UPDATE_EXTRACT_ERR_CANTPING_CONTACTHOST'); ?>
		</p>
	</div>
</div>
...
<div id="extractError" style="display: none">
	<div class="akeeba-block--failure">
		<h4>
			<?php echo \Awf\Text\Text::_('SOLO_UPDATE_EXTRACT_ERR_EXTRACTERROR_HEADER'); ?>
		</h4>
